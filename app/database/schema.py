...
class BaseMixin:
    ...
    @classmethod
    def getallsort(cls, session: Session = None, **kwargs):
        """
        Simply get a Row
        :param session:
        :param kwargs:
    ...
    @classmethod
    def getsort(cls, session: Session = None, **kwargs):
        """
        Simply get a Row
        :param session:
        :param kwargs:
    ...
    def update(self, auto_commit: bool = True, **kwargs):
...
class AnalDept(Base, BaseMixin):
    __tablename__ = "pharm_AnalDept"
    DeptSeq = Column(String(length=200), nullable=False, primary_key=True)
    DeptName = Column(String(length=200), nullable=False)

class AnalGroup(Base, BaseMixin):
    __tablename__ = "pharm_AnalGroup"
    GroupSeq = Column(Integer, nullable=False, primary_key=True)
    GroupName = Column(String(length=200), nullable=False)
    UserID = Column(Integer, nullable=True)      

class AnalSecu(Base, BaseMixin):
    __tablename__ = "pharm_AnalSecu"
    IDX = Column(Integer, nullable=False, autoincrement=True, primary_key=True)
    DeptSeq = Column(Integer, nullable=False)
    DeptName = Column(String(length=200), nullable=False) 
    UserId = Column(String(length=200), nullable=False)
    EmpName = Column(String(length=200), nullable=False)
    MenuId = Column(Integer, nullable=False)
    MenuName = Column(String(length=300), nullable=False)
    MenuUrl = Column(String(length=300), nullable=False)
    Sort = Column(Integer, nullable=True)
    YN = Column(String(length=1), nullable=False)
    LastDateTime = Column(DateTime, nullable=False, default=func.utc_timestamp())    

class AnalSecuDept(Base, BaseMixin):
    __tablename__ = "pharm_AnalSecuDept"
    IDX = Column(Integer, nullable=False, autoincrement=True, primary_key=True)
    DeptSeq = Column(Integer, nullable=False)
    DeptName = Column(String(length=200), nullable=False)
    MenuId = Column(Integer, nullable=False)
...
class AnalSecuGroup(Base, BaseMixin):
    __tablename__ = "pharm_AnalSecuGroup"
    IDX = Column(Integer, nullable=False, autoincrement=True, primary_key=True)
    GroupSeq = Column(Integer, nullable=False)
    GroupName = Column(String(length=200), nullable=False)
    MenuId = Column(Integer, nullable=False)
    MenuName = Column(String(length=300), nullable=False)
    MenuUrl = Column(String(length=300), nullable=False)
