...
function emp_grid() {
    ...
    instance_emp1.filter('EmpName', [{code : 'contain', value : ''}])
    instance_emp1.filter('DeptName', [{code : 'contain', value : ''}])
    ...
    instance_emp2.filter('EmpName', [{code : 'contain', value : ''}])
    instance_emp2.filter('DeptName', [{code : 'contain', value : ''}])
...
function dept_grid() {
    ...
    instance_dept2.filter('DeptName', [{code : 'contain', value : ''}])
    tui.Grid.applyTheme('striped'); 
}
...
function group_grid() {
    ...
    instance_group1.filter('GroupName', [{code : 'contain', value : ''}])
    ...
    instance_group2.filter('GroupName', [{code : 'contain', value : ''}])
    tui.Grid.applyTheme('striped'); 
}
